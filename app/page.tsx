        ...
        <div className="space-y-8 mb-16">
          ...
          <div className="flex justify-center">
            <div className="relative">
              <div className="absolute -inset-4 bg-gradient-to-r from-amber-200 to-yellow-200 rounded-full blur-lg opacity-50 animate-pulse"></div>
              <div className="relative w-48 h-48 md:w-64 md:h-64 rounded-full overflow-hidden border-4 border-white shadow-2xl bg-gradient-to-br from-amber-100 to-yellow-100">
                <Image
              ...
              <div className="absolute -bottom-2 -right-2 bg-amber-700 text-white p-2 rounded-full shadow-lg">
